...
// Full class names are spelled out (not built with string interpolation) so Tailwind's
// static scanner can find each one and generate it - see RedTeamLab.tsx for the same pattern.
